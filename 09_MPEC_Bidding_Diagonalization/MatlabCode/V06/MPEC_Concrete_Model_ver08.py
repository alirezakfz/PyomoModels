...
def mpec_model(ng, nb, nl, ncda, IN_loads, gen_capacity,
    ...
    def DA_power_balance_rule(model, t):
        ...
        sum_total = sum( model.POWER_SL[i,t] + IN_loads.loc[i-1,str(t)] + model.POWER_TCL[i,t]*PU_DA*load_multiply + model.E_EV_CH[i,t]- model.E_EV_DIS[i,t]  for i in model.N) - model.solar_power[t]
