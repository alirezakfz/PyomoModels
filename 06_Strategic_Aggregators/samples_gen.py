...
# def generate_sample(price, temp, samples=10):
...
def generate_temp(temp, f_name, samples=10):
...
def generate_price(price, temp, samples=10):
    ...
    for i in range(1,time):
        ...
        # min_val=data_df.iloc[1,i]
        min_val=mean-mean * 0.3  
        
        # max_val=data_df.iloc[2,i]
        max_val=mean+mean * 0.3
